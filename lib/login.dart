  ...
  Widget _buildForm(){
    return Column(
      ...
      children: [
        ...
        _buildGreyText("Por favor, entre com as suas informações"),
        const SizedBox(height: 60),
        _buildGreyText("Endereço de E-mail"),
  ...
  Widget _buildRememberForgot(){
    return Row(
      ...
      children: [
        ...
        TextButton(onPressed: (){}, child: _buildGreyText("Esqueci minha senha"))
      ],
    );
  }
